  ...
  const slides = [
    {
      ...
      title: "Health Buddy",
      description:
        "Сервис наставников по восстановлению и сохранению здоровья.",
    },
    {
      key: 2,
      title: "Программы для клиентов",
      description:
        "Отслеживаем динамику назначений через цифровой аватар по всем параметрам организма",
    },
    {
      key: 3,
    ...
    <View style={styles.container}>
      ...
      <View style={styles.wrapper}>
        ...
        <View style={{ top: "-30%" }}>
          ...
          >
            <Text style={styles.skipBtnTitle}>Пропустить</Text>
          </Pressable>
        </View>
      </View>
    </View>
...
const styles = StyleSheet.create({
  ...
  next_btn_box: {
    ...
    transform: [
      {
        translateX: Dimensions.get("screen").width / 10 - 3,
      },
    ],
  },
  next_btn: {

    ...
    <MainContainer>
      ...
      >
        ...
        <View style={{ position: "relative", alignItems: "center" }}>
          ...
          <Title titlePropStyle={{ marginTop: 8 }}>Фото в белом халате</Title>
          <Description textAlign={"center"} marginTop={5}>
            Требование: портретное фото вас в белом халате или рубашке, на
            светлом фоне
          </Description>
        </View>
        ...
        <CustomButton onPress={handlePostInfo} title={"Продолжить"} />
      </KeyboardAwareScrollView>
    </MainContainer>
  );
};

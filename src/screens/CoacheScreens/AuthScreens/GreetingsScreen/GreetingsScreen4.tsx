        ...
        {!user_data.specialization ? (
          <View style={{ flex: 1 }}>
            ...
            <TouchableOpacity
              ...
              style={[
                styles.day_question,
                coachTutorialDays[1]?.passed && styles.question_completed_style,
              ]}
              onPress={() => {
            ...
            <TouchableOpacity
              ...
              style={[
                styles.day_question,
                coachTutorialDays[2]?.passed && styles.question_completed_style,
              ]}
              onPress={() => {
            ...
            <TouchableOpacity
              ...
              style={[
                styles.day_question,
                coachTutorialDays[3]?.passed && styles.question_completed_style,
              ]}
              onPress={() => {
            ...
            >
              <Title titlePropStyle={{ marginBottom: 4 }}>

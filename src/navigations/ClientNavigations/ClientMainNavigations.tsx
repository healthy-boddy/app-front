...
import {
    TaskDetailsScreenClientFlow
} from "../../screens/ClientScreens/MainScreens/HomeScreen/task-details-screen-client-flow";
...
export default function ClientMain() {
    return (
        <Stack.Navigator
            ...
            <Stack.Screen name="PaidQuizzes" component={PaidQuizzes}/>
            <Stack.Screen name="TyPage" component={TyPage}/>
            <Stack.Screen name="AddAnalyzes" component={AddAnalyzesScreen}/>
            <Stack.Screen name="AddManual" component={AddManual}/>
            <Stack.Screen name="SaveAnalyzesScreen" component={SaveAnalyzes}/>
            <Stack.Screen name="AnalyseSingle" component={AnalyseSingle}/>
            <Stack.Screen name="EditAnalyse" component={EditAnalyse}/>
            <Stack.Screen name="AnalyseResult" component={AnalyseResult}/>
            <Stack.Screen name="UserEditName" component={UserEditName}/>

            <Stack.Screen name="GoalsClientDetails" component={GoalsClientDetails}/>

            <Stack.Screen name="DetailsProgramClient" component={DetailsProgramClient}/>

            <Stack.Screen name={"TaskDetails"} component={TaskDetailsScreen}/>

            <Stack.Screen name={"TaskDetailsClientScreen"} component={TaskDetailsClientScreen}/>

            <Stack.Screen name={"ProgramDetailGoals"} component={ProgramDetailGoals}/>

            <Stack.Screen name={"TaskDetailsScreenClientFlow"} component={TaskDetailsScreenClientFlow}/>
        </Stack.Navigator>
    );
}

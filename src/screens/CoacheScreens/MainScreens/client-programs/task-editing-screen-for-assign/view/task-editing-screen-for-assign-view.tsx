...
import { InputTasks } from "../../client-programs/view/components/input-tasks";

export const TaskEditingScreenForAssignView =
  TaskEditingForAssignModel.modelClient((props) => {

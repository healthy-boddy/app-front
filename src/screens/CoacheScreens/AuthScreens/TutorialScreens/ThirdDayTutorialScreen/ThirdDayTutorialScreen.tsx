...
const ThirdDayTutorialScreen = () => {
        ...
        <MainContainer>
          <View style={{ flex: 1 }}>
            ...
            <Description marginTop={8} marginBottom={24}>
              Если поставить неверную цель и не разбить ее на задачи, добиться
              результата будет невозможно.
            </Description>
            <Title>Идея VS Цель VS Задача</Title>
            <Description>
            ...
            <Title titlePropStyle={{ marginBottom: 10 }}>Задание</Title>
            <Description>Посмотрите видео о коучинговых механиках</Description>
      ...
      return (
        <MainContainer>
          <View style={{ flex: 1 }}>
            ...
            />
            <Title
              titlePropStyle={{ fontSize: 24, marginTop: 14, marginBottom: 8 }}
            >
        ...
        <MainContainer>
          <KeyboardAwareScrollView>
            <View style={{ flex: 1 }}>
              ...
              <Description marginVertical={12}>Цель должен быть:</Description>
              <Description width={"100%"}>
                {`\u2022 краткострочные,`}
                {"\n"}
                {`\u2022 долгосрочные,`}
              ...
              <Description width={"100%"} marginBottom={5}>
                1. Клиент 45 лет, мужчина, жалобы на боли в области сердца,
                лишний вес 5 кг, отсуствие либидо, программа 3 месяца
              </Description>
              <Description width={"100%"}>
                2. Клиент 30 лет, женщина, усталость, слабость, выпадение волос,
                проблемы со стулом и настроением, программа 6 месяца
              </Description>
  ...
  return <View style={{ flex: 1 }}>{renderPages()}</View>;
};

  ...
  return (
    <MainContainer>
      ...
      <View style={{ flex: 1, marginTop: 10 }}>
        <Title>Цель проекта Health Buddy</Title>
        <Description marginTop={8} marginBottom={24}>
          Мотивация клиента на командную работу для восстановления ресурса
          организма через коучинговые методики.
        </Description>
        <Title titlePropStyle={{ marginBottom: 8 }}>Задание</Title>
        <Description>Посмотрите презентацию, чтобы узнать о:</Description>
